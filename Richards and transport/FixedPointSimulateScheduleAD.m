function [wellSols, states, schedulereport] = ...
      FixedPointSimulateScheduleAD(initState, model, schedule, varargin)
...
%}
    ...
    %solver = NonLinearSolverAnderson('linearSolver', opt.LinearSolver);
    if model.Anderson == 1
        solver = NonLinearSolverAnderson('linearSolver', opt.LinearSolver);
    end
    ...
    %% We create the analyticalForce environment
    for i=1:size(model.forces,2)
